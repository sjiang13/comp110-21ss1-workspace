...
7. Select the `backup` remote that is your personal workspace on GitHub. If you do not see `backup` listed, see the instructions below on _Setup Backup Course Material Repository_.
   ...
   - `https://github.com/comp110-21ss1/comp110-workspace-21ss1-USERNAME`
...
5. Click the link to your personal backup repository that looks something like this `https://github.com/comp110-21ss1/comp110-workspace-21ss1-kakiryan` (except instead of `kakiryan` you will see your GitHub username).
